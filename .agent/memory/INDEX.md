...
- [reported-working-configurations](reported-working-configurations.md), the machines players report the mod working on and where each report came from, including Linux through Proton on GE-Proton11-7, which the readme claims and nothing else recorded
