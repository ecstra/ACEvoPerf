...
- [reported-working-configurations](reported-working-configurations.md), the machines players report the mod working on and where each report came from, Nvidia and a Radeon RX 6600 and Linux through Proton, plus the two cards whose only report is an unresolved visual one
