...
- [BUG-021-textures-blur-at-the-red-bull-ring-with-the-reload-fix](BUG-021-textures-blur-at-the-red-bull-ring-with-the-reload-fix.md), textures blur then sharpen driving the Red Bull Ring, and with the reload fix on the streamer turns away twice as many loads for space
