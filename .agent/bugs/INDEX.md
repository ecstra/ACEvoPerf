...
- [BUG-009-one-percent-lows-far-below-average](BUG-009-one-percent-lows-far-below-average.md), the same gap on the owner's 5070 desktop with no integrated GPU rules out the integrated GPU present path, the UI view rotation is about 30 percent of the gap at the Red Bull Ring GP and the HUD every frame removes it at no cost, no refresh hold on this laptop even at 60 Hz, the fix build next
