...
`enable_pso_cache=false` in `dist/acevo_perf.ini` since 2026-09-12, with a one line note beside it
since the ini went to one line per setting on 2026-09-13. The readme no longer advertises the shader
