...
- [docs/INDEX.md](docs/INDEX.md), the knowledge library: 24 docs in four categories
...
- [bugs/INDEX.md](bugs/INDEX.md), the defect tracker: 10 open, 7 fixed, 4 won't fix
