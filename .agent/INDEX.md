...
- [reviews/INDEX.md](reviews/INDEX.md), code review ledgers: 8 open, the full review of main of
  2026-09-20 split one branch per angle, 151 findings, 12 of them breaks, and 6 closed. The Cohtml
  build guard, render, proxy and core, package override layer and session leak angles are merged
  into 0.4
