...
layer has closed its first batch, and every other batch waits on the owner's word.
...
- [2026-09-sweep-review-overlay](2026-09-sweep-review-overlay/ledger.md), an unlocked lazy build of a
  ...
  and five verifier passes, one of them left for batch 2. Batch 1 closed and runtime confirmed
