...
below them are open. The session leak fix has closed its first batch, and every other batch waits on
the owner's word.
...
- [2026-09-fix-review-session-leak-safety](2026-09-fix-review-session-leak-safety/ledger.md), the hand
  ...
  batch 1's two hunters and four verifier passes and 13 from batch 2's hunters and first verifier
  pass. Batch 1 closed and runtime confirmed, its two findings left open on the owner's choice in
  DEC-023, batch 2 fixing
