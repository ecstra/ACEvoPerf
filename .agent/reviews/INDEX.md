...
- [2026-09-fix-review-shutdown](2026-09-fix-review-shutdown/ledger.md), the log lock a dead thread can
  ...
  handed over from the Cohtml build guard angle, plus 13 from batch 1's hunter and verifier and 7 from
  batch 2's, both batches closed and runtime confirmed, waiting on the owner's word to merge
