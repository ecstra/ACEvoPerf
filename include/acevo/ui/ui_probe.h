...
// page script to the menu and HUD view that counts what the pages change and what the responsive UI's
// page fixes do. Call from DllMain before InstallCohtmlHooks.
void InstallUiProbe();
