...
// Makes the game update its menu and its HUD every frame during a session, where it updated them one frame
// in three, part of the responsive UI. Called once from DllMain while the process is still single threaded,
